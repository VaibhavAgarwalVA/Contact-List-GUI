...
public class delete_GUI {
	...
	private void initialize() {
		...
		JLabel lblDeletionPortal = new JLabel("Deletion Portal");
		lblDeletionPortal.setBounds(157, 30, 119, 15);
		frame.getContentPane().add(lblDeletionPortal);
		
		JButton btnPersonal = new JButton("Personal");
		btnPersonal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dropdown_GUI obj= new dropdown_GUI(0,1);
		...
		btnProfessional.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dropdown_GUI obj= new dropdown_GUI(0,2);
				obj.frame.setVisible(true);
			}
		});
		...
		btnCasual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dropdown_GUI obj= new dropdown_GUI(0,4);
				obj.frame.setVisible(true);
			}
		});
		...
		btnRelatives.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dropdown_GUI obj=new dropdown_GUI(0,3);
				obj.frame.setVisible(true);
			}
		});
